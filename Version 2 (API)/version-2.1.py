                ...
                for symbol in symbols:
                    ...
                    if signal == 'BUY' and not current_position:
                        ...
                        if qty > 0:
                            ...
                            print(f"Placing BUY order: {qty} shares, SL: ${stop_loss:.2f}, TP: ${take_profit:.2f}")
                            ...
                            if order:
                                self.active_orders[symbol] = order.id if hasattr(order, 'id') else 'simulated'
                        else:
                        ...
                        if qty > 0:
                            print(f"Placing SELL order: {qty} shares")
